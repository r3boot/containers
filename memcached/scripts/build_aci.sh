...
acbuild --debug set-name memcached
...
acbuild --debug run -- apk add memcached
acbuild --debug set-exec /usr/bin/memcached -- -u memcached
acbuild --debug write ./build/memcached-${VERSION}-amd64.aci
acbuild end
